...
while true; do
    ...
    echo "7: Install TLS350/450 System Status"
    ...
    case $choice in
        ...
        [7]* ) echo "${red}... installing TLS350/450 System Status${rst}"; wget -O ~/dips/api.js https://raw.githubusercontent.com/francorosa/v-installer/master/api_both.js; npm i serialport; break;;
